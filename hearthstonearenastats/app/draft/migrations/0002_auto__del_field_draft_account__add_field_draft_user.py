...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Draft.account'
        db.delete_column(u'draft_draft', 'account_id')

        # Adding field 'Draft.user'
        db.add_column(u'draft_draft', 'user',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Draft.account'
        raise RuntimeError("Cannot reverse this migration. 'Draft.account' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Draft.account'
        db.add_column(u'draft_draft', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.Account']),
                      keep_default=False)

        # Deleting field 'Draft.user'
        db.delete_column(u'draft_draft', 'user_id')
